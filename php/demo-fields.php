...
ff_create_field('ff-demo-fields-a-email-field', 'text', array(
	'label' => __('A email field', 'fields-framework'),
	'validator' => array('validation-engine' => 'validate[required,custom[email]]'),
));

ff_add_field_to_section('ff-demo-fields', 'ff-demo-fields-a-email-field');
?>